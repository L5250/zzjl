                        ...
                        <div className="page-left">
                            ...
                            <div className="box2">
                                <div style={{
                                    ...
                                    <img onClick={() => { window.location.href = "./#/3" }} className="page2-set" src={require("../../static/images/2/1.svg")} alt="" />
                                </div>
                            ...
                            <div className="box3">
                                <div className="box-title">
                                    ...
                                    <img onClick={() => { window.location.href = "./#/3" }} className="tit-c" src={require("../../static/images/2/1.svg")} alt="" />
                                </div>
                                <div style={{
                                    display: "flex",
                                    justifyContent: "space-between",
                            ...
                            <div>
                                <div className="box-title">
                                    ...
                                    <img className="tit-b" src={require("../../static/images/2/group-7.svg")} alt="" />
                                    <img className="tit-c" src={require("../../static/images/2/1.svg")} alt="" />
                                </div>
                                <div>
                                    <div className="box-head">
                                        ...
                                        <div>
                                            ...
                                            <img src={require("../../static/images/2/shape_6.svg")} alt="" />
                                        </div>
